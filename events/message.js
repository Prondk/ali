...
if(bakım&& message.author.id!=="688402666103111790"){
 return message.channel.send("<a:settings:764197483894145026> Size Daha İyi Hizmet Verebilmek İçin Bakımdayım.")
}
